        ...
        <View className='text-white bg-[#333333] w-full h-full flex-col flex-1 my-0 mx-auto max-w-[1200px]'>
            ...
            <ScrollView className="px-[2px]">
                ...
                {Selected.map((item, index) => (
                    <LimpezaPedido_List IdMaster={item.id} cor={item.cor} navigation={navigation} key={index} id={index} empreendimento={item.empreendimento} quadra={item.quadra} numero={item.numero} status={item.status} pedido={item.pedido} />
