import ChartFinanceiro from "@/features/finance-manager/components/ChartFinanceiro";
import ChartResumoFinanceiro from "@/features/finance-manager/components/ChartResumoFinanceiro";
import {
  Card,
  CardHeader,
  CardTitle,
